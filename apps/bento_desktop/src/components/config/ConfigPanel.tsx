...
export function ConfigPanel() {
  ...
  if (error) {
    return <div className={styles.empty}>加载失败：{error}</div>;
  }
      ...
      <div className={styles.columns}>
        <section className={`iridescent-border glow-hover ${styles.column}`}>
          ...
          <div className={styles.block}>
            <h4 className={styles.blockTitle}>宿主服务（WS）</h4>
          ...
          <div className={styles.block}>
            <h4 className={styles.blockTitle}>Agent 服务（MCP）</h4>
            <div className={styles.grid}>
              <Field
                label="Host"
                value={agent.host}
        ...
        <section className={`iridescent-border glow-hover ${styles.column}`}>
          ...
          <div className={styles.block}>
            <h4 className={styles.blockTitle}>检索召回</h4>
            <div className={`${styles.grid} ${styles.gridTrio}`}>
              <Field
                label="精确通道截断"
                type="number"
          ...
          <div className={styles.block}>
            <h4 className={styles.blockTitle}>融合权重（RRF）</h4>
            <div className={styles.grid}>
              <Field
                label="RRF 平滑常数 k"
                type="number"
